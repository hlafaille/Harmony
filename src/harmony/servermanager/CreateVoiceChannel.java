...
public class CreateVoiceChannel extends JFrame {
	...
	public static void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CreateVoiceChannel frame = new CreateVoiceChannel();
	...
	public CreateVoiceChannel() {
		...
		JLabel lblCreateAServer = new JLabel("create a voice channel");
		...
		btnCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Servers.server.createVoiceChannel(txtServerName.getText());
				setVisible(false);
				AdminPanel.reshow();
				dispose();
			}
